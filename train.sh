...
# 训练PCNN+ATT+NYT-CEDA
CUDA_VISIBLE_DEVICES=2 python example/train_bag_pcnn_att.py --train_file=benchmark/nyt10-aug/nyt_train_aug8.txt --val_file=benchmark/nyt10-aug/nyt10_val.txt --test_file=benchmark/nyt10-aug/nyt10_test.txt --rel2id_file=benchmark/nyt10-aug/nyt10_rel2id.json --ckpt=pcnn_with_nyt_augmented
